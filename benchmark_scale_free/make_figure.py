"""
make_figure.py  —  Scale-free query benchmark figure
Saves to: results/scale_free_figure.png
"""
...
DB_DATA = [
    ('1,000',   'MPJ',   0.2510,    False),
    ('1,000',   'MSJ',   0.1473,    False),
    ('1,000',   'ESPM',  1.9380,    False),
    ('10,000',  'MPJ',   TIMEOUT_S, True),
    ('10,000',  'MSJ',  10.1940,    False),
    ('10,000',  'ESPM',  TIMEOUT_S, True),
    ('50,000',  'MPJ',   TIMEOUT_S, True),
    ('50,000',  'MSJ',  4058.5805,  False),
...
df_d['panel'] = 'Database Size (nodes)\n[Query fixed at 20 nodes, 37 edges]'
...
p = (
    ...
    + labs(x='', title='Scale-Free Query — Algorithm Timing')
    + theme_bw()
    + theme(
        figure_size=(12, 5),
...
out_path = os.path.join(_results, 'scale_free_figure.png')
